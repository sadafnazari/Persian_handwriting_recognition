...
The last step would be to shuffle the dataset and create the train, val, and test set based on the ratio. The output can be found in <a href="https://drive.google.com/drive/folders/1lZi71TKveuhSgGXpxAAWeNFkZHkU9SKB?usp=sharing">this link</a> as `data/04_final.zip`.
